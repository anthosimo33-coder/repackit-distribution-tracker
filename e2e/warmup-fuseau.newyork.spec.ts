 ...
 * navigateur). Ce fichier tourne dans le projet Playwright `chromium-newyork`
 * — le fuseau du navigateur ne change rien à ces assertions-ci, mais c'est là
 * que rejoindront les specs d'AFFICHAGE, où il changera tout.
 *
