...
/**
 * Accueil d'un utilisateur CONNECTÉ (monté par app/page.tsx quand le serveur
 * voit une session ; sinon c'est la page publique).
 *
 * `/` étant rendu nu par l'AppShell, la garde d'auth est posée ici : aucune
 * query tant que le jeton n'est pas hydraté.
 */
 ...
 * Rendu sous <Authenticated> (RoleRedirect ci-dessus), hors ProjectProvider : useQuery brut.
 *
